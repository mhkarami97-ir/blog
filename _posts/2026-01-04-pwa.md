---
title: "اضافه کردن PWA به وبسایت"
categories:
  - Web
tags:
  - web
...
اگ یک وب سایت دارید که می‌خواید به صورت اپلیکیشن روی موبایل و دسکتاپ هم قابل استفاده باشه، می‌تونید از PWA یا Progressive Web App استفاده کنید. در اینجا یک نمونه کامل از فایل‌های مورد نیاز برای اضافه کردن PWA به وبسایت قرار داده شده است که می‌توانید از آن استفاده کنید.
همچنین در این کدها بخش نوتیفیکیشن و سینک در پس‌زمینه هم اضافه شده است.  
